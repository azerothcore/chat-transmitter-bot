...
export class elunaChannel1685494033960 implements MigrationInterface {
	...
	public async up(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(`CREATE TABLE "guild" ("discord_id" varchar PRIMARY KEY NOT NULL, "misc_channel" varchar, "anticheat_reports_channel" varchar, "eluna_channel" varchar)`);
